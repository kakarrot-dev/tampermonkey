...
| 2Libra V2EX 风格双栏 | 自有脚本 | `2libra.com` | `0.3.10` | [安装原始脚本](https://raw.githubusercontent.com/kakarrot-dev/tampermonkey/main/2libra/TwoColumnPolish.user.js) |
...
把 2Libra 调整为约 805 px 主栏加 270 px 右栏，并将 V2EX Polish 的间距和排版方式应用到发帖页、帖子列表、帖子详情、嵌套回复、个人主页、设置页、足迹列表、右栏个人信息和回复编辑器。除发帖页外，桌面端右栏固定为“个人信息、帖子浏览、最近访问”的顺序，并隐藏推广卡片。普通点击帖子链接时在当前标签页打开，按住修饰键点击时保留浏览器原生行为；窄屏下恢复单栏。
